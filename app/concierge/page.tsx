  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] px-4 py-8 max-w-lg mx-auto">
      <div className="mb-8 text-center">
        ...
        <p className="text-sm text-[#888]">{brand.tagline ? `${brand.tagline} · ` : ''}bem-vindo!</p>
      </div>
      ...
      <div className="space-y-4">
        {content.wifi_ssid && (
          <div className="bg-white rounded-2xl border border-[#E0DBCF] p-5 shadow-sm">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="font-bold text-[#4A4A4A] text-base">Wi-Fi</h2>
            </div>
            <div className="space-y-2">
              <div className="flex items-center justify-between bg-[#F8F9FA] rounded-lg px-3 py-2">
                <span className="text-xs text-[#888]">Rede</span>
        ...
        <div className="bg-[#4A4A4A] rounded-2xl p-5 text-white">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="font-bold text-base">Precisa de ajuda?</h2>
          </div>
          <p className="text-sm text-[#BBB] leading-relaxed">
            Se tiver alguma dúvida, responda ao email de confirmação ou contacte-nos diretamente.
